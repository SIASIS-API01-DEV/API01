 ...
 * @param nombreUsuario Nombre de usuario del tutor a buscar
 * @param instanciaEnUso Instancia específica donde ejecutar la consulta (opcional)
 * @returns Datos del tutor con su aula o null si no existe
 */
export async function buscarTutorPorNombreUsuarioConAula(
  ...
  const result = await query(instanciaEnUso, sql, [nombreUsuario]);
...
/**
 * Busca un tutor (profesor de secundaria con aula asignada) por su nombre de usuario seleccionando campos específicos
 * @param nombreUsuario Nombre de usuario del tutor a buscar
 ...
 */
export async function buscarTutorPorNombreUsuarioConAulaSelect<
